...
{
	public class DistributorRemainAdapter2 : BaseAdapter<DistributorRemain>
	{
		readonly Activity Context;
		readonly IList<DistributorRemain> DistributorRemains;

		public DistributorRemainAdapter2(Activity context, IList<DistributorRemain> distributorRemains)
		{
			Context = context;
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			view.FindViewById<TextView>(Resource.Id.drtiRemainTV).Checked = item.remain.ToString();
